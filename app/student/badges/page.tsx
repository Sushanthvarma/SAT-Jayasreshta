      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        {earnedBadges.length === 0 ? (
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-12 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">No Badges Yet</h3>
            <p className="text-gray-600 mb-6">Complete tests and maintain streaks to earn badges!</p>
            <Link
              href="/student"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {earnedBadges.map((badge) => (
              <div
                key={badge.id}
                className="bg-white rounded-xl shadow-md p-8 border-2 border-purple-200 hover:shadow-xl hover:scale-105 transition-all text-center"
              >
